...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676644844955.png)

它写的太复杂了，我想要更简洁的版本，没事，你可以直接告诉它！！

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676644955289.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676645803478.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676891119455.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676891803316.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676892021752.png)

如上的代码都是可以直接使用的，也充分符合了我们的需求，甚至可以更过分一些：

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676892456397.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676893597110.png)

上面的文档生成是有错误的，不知道大家发现了没有，需要提醒大家的是，`ChatGPT` 是一个需要调教的程序，你要反复不断地告诉他你的需求，你的想法，他才能理解你最终的意思，所以我们应该继续追问：

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676893966253.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676892918206.png)

#### 生成模拟数据

我们已经有了一个 Typescript 实体，让`ChatGPT`再帮我们返回一些测试数据吧！

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676893159996.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676898494825.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676894411346.png)


## 简化工作流程

上面的实践是告诉我们在代码的开发方便，`ChatGPT` 有很强的可塑性，也有完整的能力帮助我们去实现一些基本的需求。

那么在简化工作流程方面，`ChatGPT` 又能带给我们哪些惊喜呢！

### 给我一个最佳的 ESLint 配置

非常常见的需求，网上的文章也是一抓一大把，不做过多的赘述，我们主要看得是，`ChatGPT` 的可塑性有多强，说实话，我使用该功能的时候确实有一点惊讶，它带给我的惊喜太多了，导致我是在有点把持不住！

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676899278900.png)

### 替换为 Prettier

这个需求主要是演示 `ChatGPT` 的上下文关联，正因为有此特性，才能实现更智能的连续对话！

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676899360221.png)

### 我要一个雪碧图

那么对于我们在项目中非常常用的需求，直接问他实现方式就可以了，多么希望搜索引擎快点集成这些功能啊，`New Bing` 已经集成了这些功能，有希望成为第一个集成 `ChatGPT` 并量产化的搜索引擎，期待期待！

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676899888947.png)

### 我要 GitHub 上的最佳示例

Github 上的内容通常会比较繁杂，需要精准去定位需求是比较艰难的，它同样可以去帮我们进行筛选:

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676900222756.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676900796791.png)

### 我要点赞

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676902947102.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676906161074.png)
