...
![uTools官方PPT介绍](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676267825324.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676267899068.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/20230213_141140.gif)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676269637134.png)

本文中使用的所有图片都是通过该插件上传至我的七牛云中，并获取链接的，看看我是怎么做的：

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/20230213_143103.gif)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/20230213_145113.gif)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/20230213_150240.gif)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676272447014.png)

两个插件皆可以进行批量操作，以下演示为我平时使用的效果：

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676272930293-20230213_151902.gif)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676273192614.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676273566561.png)

### 正则表达式

在写代码的过程中，我们也经常使用一些正则表达式，想要记住这么多正则是比较困难的，庆幸的是，我们有很多的辅助工具可以用来做到，我这里推荐的是 `Any Rule` 插件，他提供了数十个常用的正则，在开发过程中一键唤起，搜索即可

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676274960179.png)

我们可以利用`正则编辑器`插件对正则进行简单有效的编辑或解释。

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676275138185.png)

### 剪切板

这是我**使用频率最高**的一个插件，在复制很多内容时，记录剪切板数据很有效，我使用的官方提供的`剪贴板`插件，这个插件是一个会员插件，当然，社区的力量是强大的，还有`超级剪贴板`这个免费且强大的插件！

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676275348230.png)

在插件市场中搜索剪贴板，就可以找到 `超级剪贴板`

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676275408793.png)

### 密码管理器

密码管理器五花八门，管理的密码也五花八门，可以自行在插件市场搜索 `密码` 即可，根据自己的喜好选择一个，我使用的是官方的 `密码管理器` 插件

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676275551088.png)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676275759337.png)

我平时的使用如下：

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/20230213_161057.gif)
...
![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676276255526.png)

![](http://rq07mqsm6.hn-bkt.clouddn.com/u-image-bed/1676276284242.png)
