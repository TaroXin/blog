...
export default <VdoingThemeConfig>{
  ...
  logo: "/assets/img/header.png", // 导航栏Logo
  repo: "taroxin", // 导航栏右侧生成Github链接
  ...
  bodyBgImg: [
    'https://taro-sources-1253403255.cos.ap-guangzhou.myqcloud.com/2023-6/bg.jpeg',
  ...
  author: {
    ...
    name: "TaroXin/泰罗凹凸曼", // 必需
    link: "https://github.com/taroxin", // 可选的
  },

  // 博主信息，显示在首页侧边栏
  blogger: {
    avatar: "https://taro-sources-1253403255.cos.ap-guangzhou.myqcloud.com/2023-6/header.png",
    name: "泰罗凹凸曼/TaroXin",
    slogan: "凹凸曼界最会写代码的",
  },
    ...
    icons: [
      {
        ...
        title: "GitHub",
        link: "https://github.com/taroxin",
      },
      {
        iconClass: "icon-juejin",
        title: "掘金",
        link: "https://juejin.cn/user/4459274890904632/posts",
      },
      {
        iconClass: "icon-bilibili",
        title: "哔哩哔哩",
        link: "https://space.bilibili.com/21371785",
      },
      {
        iconClass: "icon-youjian",
        title: "发邮件",
        link: "mailto:15029352778@163.com",
      },
    ],
  },
  footer: {
